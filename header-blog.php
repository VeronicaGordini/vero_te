...
<script language="javascript" type="text/javascript" src="<?php bloginfo( 'stylesheet_directory' ); ?>/js/jquery.scrollTo.js" > </script>
<script language="javascript" type="text/javascript" src="<?php bloginfo( 'stylesheet_directory' ); ?>/js/easing.js" > </script>
...
<body <?php body_class(); ?>>
  <div id="page" class="hfeed">
	...
	<header id="branding" role="banner">
		...
		<a href="http://localhost:8888/verowebdesigner" id="home_p" class="icona" >AAAAHHHH</a>
			</nav><!-- #access -->		
		</div> <!--log_nav-->	 
	</header><!-- #branding --> 
